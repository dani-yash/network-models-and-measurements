...
# A. Graph Model Generators
    ...
    # Creating the graph.
    BarabasiAlbertGraph = nx.barabasi_albert_graph(n, m)

    # Finding the largest connected component.
    largest_cc = max(nx.connected_components(BarabasiAlbertGraph), key=len)

    # Making a copy of the graph that only has the greatest connected component.
    GCC = BarabasiAlbertGraph.subgraph(largest_cc).copy()

    # Basic graph parameters.
    print("The n value for ba", effective_run, end=" ")
    print("was: ", n,)
    print("The k value for ba", effective_run, end=" ")
    print("was: ", m)
    print("For ba", effective_run, end=", ")
    ...
    plt.savefig('BA{}.png'.format(effective_run), dpi=600)
...
# B. Degree Distribution Plot
    ...
    # Saving the graph as an image.
    plt.savefig('BA{}DD.png'.format(effective_run), dpi=600)
...
# B. Clustering Plot
    ...
    # Saving the graph as an image.
    plt.savefig('BA{}CP.png'.format(effective_run), dpi=600)
